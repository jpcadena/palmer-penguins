...
<h3 align="center">palmer-penguins</h3>

  <p align="center">
    Description for Palmer penguins
    <br />
    <a href="https://github.com/jpcadena/palmer-penguins"><strong>Explore the docs »</strong></a>
    <br />
  </p>
</div>
...
This project is about Palmer penguins...
...
1. Clone the **repository**
    ```
    git clone https://github.com/jpcadena/palmer-penguins.git
    ```
...
E-mail: [Juan Pablo Cadena Aguilar](mailto:jpcadena@espol.edu.ec?subject=[GitHub]palmer-penguins)
